package ru.BeYkeRYkt.LightAPI.nms.PaperSpigot.v1_7_R4;
	...
	public void updateChunk(ChunkInfo cCoord) {
		...
		for (Object human : chunk.world.players) {
			...
			if (distanceTo(pChunk, chunk) < 5) { 
				PacketPlayOutMapChunk packet = new PacketPlayOutMapChunk(chunk, false, 65535, player.playerConnection.networkManager.getVersion());
